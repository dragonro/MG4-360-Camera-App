...
REM DriveHub_Kadran icin standart debug APK yolu
...
set APK_TOOLS_NAME=DriveHub_Kamera_Debug_%VERSION_NAME%.apk
...
echo.
echo ============================================================
echo  DriveHub_Kadran DEBUG APK Imzalama ve Kurma
echo ============================================================
